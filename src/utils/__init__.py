"""Utility package for the Bonfire project.

This package contains helper functions for building and managing job
applications, including date formatting, filename generation, and Markdown
file reading.
"""
...
def set_file_name(apply_doc: str, language: str, personal_info: PersonalInfo) -> str:
    ...
    Args:
        ...
        personal_info: The candidate's personal information used to build the filename.
